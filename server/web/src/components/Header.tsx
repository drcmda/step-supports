    ...
    <header className='fixed top-0 left-0 right-0 z-50 border-b border-border/50 py-3.5 bg-base/80 backdrop-blur-md'>
      <div className='max-w-[1200px] mx-auto px-6 flex items-center justify-between'>
        ...
        <nav className='flex items-center gap-5'>
          <Link
            to='/generate'
            className='font-mono text-[11px] tracking-[0.08em] text-primary/35 no-underline transition-colors hover:text-primary/60'>
            Generate
          </Link>
          <Link
            to='/docs'
          ...
          <a
            ...
            className='font-mono text-[11px] tracking-[0.08em] text-primary/35 no-underline transition-colors hover:text-primary/60 cursor-pointer'>
            Pricing
          </a>
